...
Public Class rptInventaris
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "aInventaris.rptInventaris.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptInventaris
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptInventaris = New rptInventaris
        rpt.Site = Me.Site
        Return rpt
    End Function
